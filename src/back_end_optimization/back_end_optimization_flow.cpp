...
namespace lidar_imu_calib{
    BackEndOptimizationFlow::BackEndOptimizationFlow(ros::NodeHandle& nh) {
        ...
        gnss_pub_ptr_ = std::make_shared<OdometryPublisher>(nh, "/synced_gnss_back", "/map", "/velo_link", 100);
...
//        static bool is_first_key_frame=true;
//        static Eigen::Matrix4f init_gnss_pose;
...
//
//            init_gnss_pose=key_frame_data.gnss_pose;
//            key_frame_data.gnss_pose.block<3, 3>(0, 0) = Eigen::Matrix3f::Identity();
//            is_first_key_frame=false;
//            gnss_pub_ptr_->Publish(key_frame_data.gnss_pose, key_frame_data.time);
...
//        }
        ...
        key_frame_data.frame_pose=current_key_frame_.pose;
        key_frame_data.gnss_pose = current_key_gnss_.pose;
        //key_frame_data.gnss_pose.block<3,3>(0,0)
        key_frame_data.cloud_ptr = current_key_scan_.cloud_ptr;
