...
//静态成员变量必须在类外初始化
double lidar_imu_calib::GNSSData::origin_longitude = 0.0;
double lidar_imu_calib::GNSSData::origin_latitude = 0.0;
double lidar_imu_calib::GNSSData::origin_altitude = 0.0;
bool lidar_imu_calib::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian lidar_imu_calib::GNSSData::geo_converter;
...
//                std::cout << "gnss unsync time:" << UnsyncedData.front().time << std::endl;
//                std::cout << "gnss sync time:" << sync_time << std::endl;
                return false;
            }


            if (UnsyncedData.at(1).time < sync_time) {
//                std::cout << "diff time:" << sync_time - UnsyncedData.at(1).time << std::endl;
...
//            std::cout << "gnss size problem" << std::endl;
            return false;
        }
